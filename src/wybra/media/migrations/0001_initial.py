    ...
    operations = [
        ops.CreateModel(
            ...
            options={
                "table": "media_item",
                "app": "wybra_media",
                "indexes": [Index(fields=["category"]), Index(fields=["created_at"])],
                "pk_attr": "id",
                "table_description": "Catalogued media item stored under the configured media root.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_media",
                "pk_attr": "resource_key",
                "table_description": "Lookup key assigned to a media item for stable resource references.",
            },
            bases=["Model"],
        ),
    ]
