...
class Migration(migrations.Migration):
    ...
    operations = [
        ops.CreateModel(
            ...
            options={'table': 'messages_alert', 'app': 'wybra_messages', 'indexes': [Index(fields=['queue_key', 'id'])], 'pk_attr': 'id', 'table_description': 'Queued user-facing alert stored by the database messages backend.'},
            bases=['Model'],
        ),
    ]
