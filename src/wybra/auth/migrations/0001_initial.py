    ...
    operations = [
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "id",
                "table_description": "Serialises initial admin bootstrap state.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "pk_attr": "id",
                "table_description": "Canonical provider identity row used by external login flows.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "pk_attr": "id",
                "table_description": "Canonical local user account.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "id",
                "table_description": "Authorisation group used to collect reusable scopes.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "scope",
                "table_description": "Authorisation scope assignable to groups.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "token",
                "table_description": "Server-side browser session token.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
        ...
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "id",
                "table_description": "Additional email addresses for local user accounts.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "id",
                "table_description": "A TOTP secret and its current lifecycle state.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
            ...
            fields=[
                (
                    "id",
                    fields.CharField(
                        primary_key=True, unique=True, db_index=True, max_length=32
                    ),
                ),
                (
                    "user",
            ...
            options={
                ...
                "app": "wybra_auth",
                "pk_attr": "id",
                "table_description": "Transient authentication challenge metadata.",
            },
            bases=["Model"],
        ),
        ops.CreateModel(
