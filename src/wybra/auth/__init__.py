...
_EXPORTS = {
    ...
    "ProviderCredentialStore": "wybra.auth.provider_credentials",
    ...
    "TortoiseChallengeStore": "wybra.auth.mfa.storage",
    "TortoiseRecoveryCodeStore": "wybra.auth.mfa.storage",
    "TortoiseTOTPCredentialStore": "wybra.auth.mfa.storage",
    "TortoiseWebAuthnCredentialStore": "wybra.auth.mfa.storage",
