...
helpers return sources in reverse configured order so later configured modules
have override precedence over earlier foundation modules.
"""
...
from web_core.composition import CompositionError
from web_core.context import ContextProvider, get_context_providers
from web_core.conventions import (
...
from web_core.diagnostics import configured_module_message, surface_message
        ...
        raise CompositionError(
            surface_message(
                ...
                (
                    ...
                    "web_core.routing.ModuleRoutes instance."
                ),
            )
        )
