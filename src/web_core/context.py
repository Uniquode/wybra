...
from web_core.diagnostics import diagnostic_message
...
REQUEST_CONTEXT_STATE_ATTRIBUTE = "web_core_template_context"
...
def web_core_theme_context(request: Any) -> dict[str, str]:
    from starlette.routing import NoMatchFound

    from web_core.theme import THEME_MODE_ROUTE_NAME, theme_template_context
...
__all__ = [
    ...
    "web_core_theme_context",
]


add_to_context(web_core_theme_context)
