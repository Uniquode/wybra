...
from web_core.context import validate_context_providers
from web_core.renderer import TemplateRenderer
from web_core.resources import PackageResourceSource, first_existing_resource
from web_core.routing import load_module_routes
from web_core.style_contract import (
...
if TYPE_CHECKING:
    from web_core.composition import AppConfig
