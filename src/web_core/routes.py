...
from web_core.route_contract import API_PATH_PREFIX, PARTIAL_PATH_PREFIX
from web_core.routing import HtmlRouteDefinition, ModuleRoutes
from web_core.theme import (
...
def build_web_core_module_routes() -> ModuleRoutes:
...
module_routes = build_web_core_module_routes()

__all__ = [
    "build_web_core_module_routes",
    "module_routes",
]
