...
from web_core.form_security import is_safe_method
from web_core.renderer import TemplateRenderer
from web_core.route_contract import PARTIAL_PATH_PREFIX
from web_core.routing import (
    HtmlRouteDefinition as HtmlRouteDefinition,
)
from web_core.routing import (
    HtmlSurface as HtmlSurface,
)
from web_core.routing import (
