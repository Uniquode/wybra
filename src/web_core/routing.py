...
from web_core.diagnostics import surface_message
...
def load_module_routes(
    ...
    *,
    ...
    from web_core.surfaces import discover_module_routes
...
def register_module_routes(
    ...
    from web_core.dispatcher import register_html_routes
