...
def test_wybra_auth_package_is_independent_from_application_modules() -> None:
...
def test_wybra_auth_result_carries_success_values_and_failure_reason() -> None:
...
def test_wybra_auth_default_password_policy_scores_and_accepts_passphrases() -> None:
...
def test_wybra_auth_identity_options_accept_custom_password_policy() -> None:
...
def test_wybra_auth_integration_options_enabled() -> None:
...
def test_wybra_auth_totp_auth_uri_rejects_unknown_algorithm() -> None:
...
def test_wybra_auth_totp_verification_limits_allowed_drift() -> None:
    secret = "JBSWY3DPEHPK3PXP"
...
def test_wybra_auth_identity_options_reject_invalid_totp_settings() -> None:
...
def test_wybra_auth_identity_options_integration_enabled_rejects_unknown() -> None:
    options = IdentityOptions()
...
def test_wybra_auth_password_failure_message_filters_unrecognised_reasons() -> None:
    assert (
...
def test_wybra_auth_no_challenge_policy_allows_direct_login() -> None:
...
def test_wybra_auth_provider_disabled_identity_options_do_not_require_secret_keys() -> (
    None
):
...
def test_wybra_auth_router_extension_plan_tracks_explicit_replacements() -> None:
